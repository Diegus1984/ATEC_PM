...
namespace ATEC.PM.Client.Views.Commerciale.Preventivi.Models;
...
public class MaterialTreeRow : INotifyPropertyChanged
{
    ...
    /// <summary>Gruppo prodotto per aggiornare il totale in testata al cambio prezzo.</summary>
    public MaterialProductGroup? ParentGroup { get; set; }
