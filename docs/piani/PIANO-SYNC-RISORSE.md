...
| **1 — Anagrafiche PM → VPS + seme mappa** | giro anagrafiche, seme per nome, log | sul VPS compaiono le commesse vere e Abatangelo resta se stessa; test unitari sull'abbinamento e sull'impronta |
