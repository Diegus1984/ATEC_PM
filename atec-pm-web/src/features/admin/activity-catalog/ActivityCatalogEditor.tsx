...
// Editor dell'anagrafica attività: la griglia con aggiungi, rinomina inline, riordino
// drag-and-drop, disattiva/elimina e «Ripristina standard». Vive in un componente a sé
// perché lo usano DUE posti: la pagina `/anagrafica-attivita` e il dialogo richiamato dal
// form commessa (blocco 7), dove si aggiunge la voce che manca senza perdere la commessa
// che si sta creando.
export function ActivityCatalogEditor() {
  ...
  // Invalida anche la lista delle sole voci ATTIVE: è quella che alimenta il precarico
  // attività del form commessa, che deve riallinearsi appena si esce da qui.
  const invalidate = async () => {
    await queryClient.invalidateQueries({ queryKey: ["activity-catalog"] })
  }
