...
export const NAV_GROUPS: NavGroupConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        // Le viste del Gestore DDP sono anche sottovoci del menu (Diego, 08/09/2026).
        id: "gestore-ddp-group",
        label: "Gestore DDP",
        path: "/gestore-ddp",
        ...
        children: [
          ...
          {
            id: "gestore-ddp-controllo",
            label: "Report di controllo",
            path: "/gestore-ddp/controllo",
            featureKey: "nav.gestore_ddp",
            icon: ClipboardCheck,
            status: "live",
            description: "I report di controllo delle DDP: ritardi, verifiche, check, righe da ordinare e da consegnare.",
          },
          {
            id: "gestore-ddp-consegne",
            label: "Analisi consegne",
            path: "/gestore-ddp/controllo/consegne",
            featureKey: "nav.gestore_ddp",
            icon: BarChart3,
            status: "live",
            description: "Le consegne attese giorno per giorno.",
          },
          {
            id: "gestore-ddp-magazzino",
            label: "Feedback magazzino",
            path: "/gestore-ddp/feedback/magazzino",
            featureKey: "nav.gestore_ddp",
            icon: Warehouse,
            status: "live",
            description: "Il ritorno del magazzino sulle righe delle DDP.",
          },
        ],
      },
      {
